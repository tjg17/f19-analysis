function [ GasTrappingVolume , GasTrappingPercentage ] = ComputeGasTrappingVolumes( image , roi , last_pfp , PatientNumber , washoutcycles , ventilated_threshold )
...
GasTrappingVolume = sum(GasTrapBinary(:))*6.25*6.25*15/1e6; % in liters
...
% 
% % Save figure
% FigureDirectory    = strcat('G:/2017-Glass/f19_fit_results/GasTrapping/');    mkdir(FigureDirectory);
